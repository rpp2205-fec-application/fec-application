...
const ReviewEntry = (props) => {
  ...
  const revBody = props.review.body;
    ...
    <li>
      <div className="rev" role="reviews">
        ...
        <div className="rev-body">
          ...
          {props.review.body.length <= 100 ? <div className="review small_font">{props.review.body}</div>
          : (<div className="review small_font">
              {props.review.body.slice(0, 100)}
              {showMore ? null : <a className="more=summary">{revBody.slice(100)}</a>}
              <br/>
